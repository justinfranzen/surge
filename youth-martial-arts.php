...
if (isset($_POST['submitted'])){
    ...
    require_once('sql/mysql_connect.php');
        ...
        $redirect = 'youth-martial-arts.php#myForm2';
        ...
        elseif (empty($location))
         ...
         $content = $fullname . " is interested in more information about the Youth Tykes Martial Arts class " . " \nEmail: " . $email;
...
<div id="main2">
    ...
    <div id="content2">
        ...
        <h1 class="title">YOUTH MARTIAL ARTS</h1>
        ...
        <br>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <form id="myForm2" action="youth-martial-arts.php" method="post" >

                        <p class="form-content">Contact us for more information about our Youth class</p>
