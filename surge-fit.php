...
if (isset($_POST['submitted'])){
    ...
    require_once('sql/mysql_connect.php');
        ...
        $redirect = 'surge-fit.php#myForm2';
        ...
        elseif (empty($location))
         ...
         $subject = "SURGE FIT Information Request";
         $content = $fullname . " is interested in more information about the SURGEFIT class " . " \nEmail: " . $email;
    ...
    <div id="content2">
        ...
        <br>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <form id="myForm2" action="surge-fit.php" method="post" >
                    
                    <p class="form-content">Contact us for more information about our SURGE FIT class</p>
